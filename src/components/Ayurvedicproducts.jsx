...
const Ayurvedicproducts = () => {
  ...
  return (
    <div className="bg-white from-emerald-50 to-teal-100 h-full py-12 px-4 sm:px-6 lg:px-8">
          ...
          {products.map((product, index) => {
            ...
            return (
              <motion.div
                ref={ref}
                key={index}
                className="bg-white rounded-xl shadow-2xl overflow-hidden transform transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl"
